ATTRIBUTES_MAP = {
    ...
    "supplied_demands_within": "Удовлетворённый спрос в нормативной доступности (чел)",
    "supplied_demands_without": "Удовлетворённый спрос вне нормативной доступности (чел)",
    ...
    "provision_value": "Оценка обеспеченности",
    "supplied_demands_within_before": "Удовлетворённый спрос в нормативной доступности (до) (чел)",
    "us_demands_within_before": "Неудовлетворённый спрос в нормативной доступности (до) (чел)",
    "supplied_demands_without_before": "Удовлетворённый спрос вне нормативной доступности (до) (чел)",
    "us_demands_without_before": "Неудовлетворённый спрос вне нормативной доступности (до) (чел)",
    "supplied_demands_within_after": "Удовлетворённый спрос в нормативной доступности (после) (чел)",
    "us_demands_within_after": "Неудовлетворённый спрос в нормативной доступности (после) (чел)",
    "supplied_demands_without_after": "Удовлетворённый спрос вне нормативной доступности (после) (чел)",
